...
import pandas as pd
import numpy as np
from windowing import INFO_COLUMNS

# Target variables are loaded from var.pkl, generated by step_2.py.
...
pickle.dump([data_sets[0], pd.DataFrame(info_sets[0], columns=INFO_COLUMNS), data_sets[1], pd.DataFrame(info_sets[1], columns=INFO_COLUMNS), data_sets[2], pd.DataFrame(info_sets[2], columns=INFO_COLUMNS)], open('data/dataset.pkl','wb'))
